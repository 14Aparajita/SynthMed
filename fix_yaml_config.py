...
with open('run_improved_experiments.py', 'w', encoding='utf-8') as f:
    f.write(fix_content)

print("Fixed YAML config issue - run_improved_experiments.py created")
